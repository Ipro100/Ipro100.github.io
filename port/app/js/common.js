...
$(".main_mnu li:first-child").click(function() {
window.scrollTo({
    top: window.screen.width * 2.6,
    behavior: "smooth"
});
console.log(window.screen.width);
});

$(".main_mnu li:nth-child(2)").click(function() {
window.scrollTo({
    top: window.screen.width * 5.2,
    behavior: "smooth"
});
  
});

$(".main_mnu li:nth-child(3)").click(function() {
window.scrollTo({
    top: window.screen.width * 40,
    behavior: "smooth"
});
